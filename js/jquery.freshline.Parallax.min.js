					...
					function startDemo() {
							...
							c.find('#bgselector').children().click(function() {
								...
								if ($this.index()==0) {	
									...
									$('body').find('.signo').attr('src','images/signo.png');
								}
								if ($this.index()==1) {	
									newsrc="css/theme-grey.css";
									$('body').find('.signo').attr('src','images/signo_grey.png');
								}
								if ($this.index()==2) {	
									newsrc="css/theme-red.css";
									$('body').find('.signo').attr('src','images/signo_red.png');
								}
								if ($this.index()==3) {	
									newsrc="css/theme-green.css";
									$('body').find('.signo').attr('src','images/signo_green.png');
								}
								if ($this.index()==4) {	
									newsrc="css/theme-yellow.css";
									$('body').find('.signo').attr('src','images/signo_yellow.png');
								}
								if ($this.index()==5) {	
									newsrc="css/theme-gold.css";
									$('body').find('.signo').attr('src','images/signo_gold.png');
								}
